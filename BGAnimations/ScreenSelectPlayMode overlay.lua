...
if GAMESTATE:IsEventMode() and not GAMESTATE:IsCourseMode() then
	t[#t+1] = LoadActor("ScreenSelectStyle overlay") .. {
		Condition=GAMESTATE:GetCurrentStyle():GetStepsType() == "StepsType_Dance_Single"; 
	};
end; ]]--
...
for pn in ivalues(GAMESTATE:GetHumanPlayers()) do
	...
	--	OffCommand=cmd(diffusealpha,0);
		...
		--	InitCommand=cmd(zoom,0.55;diffuse,PlayerColor(pn);strokecolor,color("#000000"));
