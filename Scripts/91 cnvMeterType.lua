...
function GetConvertDifficultya(song,style,dif,_metertype,mt)
	...
	tapspoint=(step:GetRadarValues(GetSidePlayer(PLAYER_1)):GetValue('RadarCategory_Stream')-0.5)*66+tapspoint;
	tapspoint=(step:GetRadarValues(GetSidePlayer(PLAYER_1)):GetValue('RadarCategory_Voltage')-0.5)*80+tapspoint;
