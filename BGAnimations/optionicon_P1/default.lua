		...
		InitCommand=function(self)
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'stealth') then
				...
				if GAMESTATE:GetPlayMode() ~= "PlayMode_Oni" and GAMESTATE:GetPlayMode() ~= "PlayMode_Rave" then
					local loadhidsud = PlayerOptionsAppearance(PLAYER_1);
					if loadhidsud == "HiddenPlus" then
						self:Load(THEME:GetPathB("","optionicon_P1/appearance_hiddenplus_P1"));
					elseif loadhidsud == "SuddenPlus" then
						self:Load(THEME:GetPathB("","optionicon_P1/appearance_suddenplus_P1"));
					elseif loadhidsud == "HiddenSuddenPlus" then
						self:Load(THEME:GetPathB("","optionicon_P1/appearance_hiddensuddenplus_P1"));
					end;
				end;
			end;
		end;
