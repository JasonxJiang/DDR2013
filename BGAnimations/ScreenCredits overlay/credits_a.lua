...
--普通の文字
local lineOn = cmd(zoomx,0.5;zoomy,0.45;horizalign,left;strokecolor,color("#2011e0");)

--見出し文字
local sectionOn = cmd(zoomx,0.5;zoomy,0.45;horizalign,left;y,-15;diffuse,0.74,0.87,0.72,1;strokecolor,color("#303101");)
